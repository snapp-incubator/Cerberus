...
//+kubebuilder:rbac:groups=cerberus.snappcloud.io,resources=webserviceaccessbindings/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cerberus.snappcloud.io,resources=webserviceaccessbindings/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the WebserviceAccessBinding object against the actual cluster state, and then
...
func (r *WebserviceAccessBindingReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&cerberusv1alpha1.WebserviceAccessBinding{}).
		Complete(r)
}
